# 2.1 · Averages, Ranges, and Deciding Without Certainty
...
group (channel, region, customer type). [File 4.1](../04_satisfy_the_regulator/01_segments_and_fairness.md) shows this question
...
data you need before you can trust a comparison ([File 2.2](02_tests_and_experiments.md)).
...
see effects — [File 2.2](02_tests_and_experiments.md)), not about the world.
...
2. **[File 2.2](02_tests_and_experiments.md)** turns "the range is wide" from an excuse into a design
...
3. **[The distributions appendix](../appendix/distributions_for_pricing.md)** makes §1's suspicion precise. "The mean lies about money"
...
4. **[The workflow appendix](../appendix/data_science_workflow.md) and [file 3.2](../03_defend_the_plan/02_kpis_and_stakeholders.md)** apply the same honesty upward: models get graded
...
5. **In code:**
   [`../05_the_panel/N4_uncertainty_to_decision.ipynb`](../05_the_panel/N4_uncertainty_to_decision.ipynb)
