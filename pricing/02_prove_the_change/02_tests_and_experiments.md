# 2.2 · Testing a Price Change Properly
...
added **+3%**. (This is the "don't claim the market's win" rule from [File 1.4](../01_set_the_rate/04_price_volume_mix_and_leakage.md),
...
longer, or accept you'll get a *range*, not a verdict ([File 2.1](01_averages_and_uncertainty.md)). Asking for
...
1. **This file:** control groups, difference-in-differences, randomisation,
   MDE, and spillover.
2. **Look back before looking up — [File 1.3](../01_set_the_rate/03_elasticity.md) §6:** this file *is* the fix for
...
3. **[File 1.5](../01_set_the_rate/05_competition.md) §5** handles the case you can't randomise (you don't control
   ...
   same instinct.
4. **[The workflow appendix](../appendix/data_science_workflow.md) §8** makes the experiment permanent: once a model sets prices,
   ...
   really ends.
5. **In code:**
   [`../05_the_panel/N1_geo_experiment_design.ipynb`](../05_the_panel/N1_geo_experiment_design.ipynb)
