...
```
**Why:** This is your first step toward elasticity estimation (notebook 08).
...
**Insight:** Which arm won? By how much? Is it statistically significant? (Needs power calculation, see notebook 09.)
...
- Revisit elastic segments: your Q7.2 findings will drive pricing strategy in notebook 10.
...
The questions above are preparation. By the time you reach notebook 07, you'll know your data intimately.
