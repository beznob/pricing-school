...
Postmaster** network, **wholesale** B2B partners such as white-label retailers and other bureaux, and third-party **agencies** such as travel agents).
...
# digital is price-transparent (most elastic) but cheap to serve; wholesale is
...
DEFAULT_CHANNELS: Dict[str, ChannelSpec] = {
    ...
    "wholesale": ChannelSpec("wholesale", -0.7, 0.018, 1500, 0.10, 1.80, 0.25, 1650, 0.20),
