...
[`../_archive/fastpay_payments/dynamic_pricing_and_elasticity_case_study.md`](../_archive/fastpay_payments/dynamic_pricing_and_elasticity_case_study.md)
...
retail, wholesale, digital, agency and the **Post Office / Postmaster** network, under
**FCA Consumer Duty**.
...
python run_role_case_study.py     # writes RESULTS.md, the stage-4 fair value assessment, role_*.png
```
...
| wholesale | −0.70 | −0.04 | **−0.68** |

**Digital is the most price-sensitive** (customers compare rates in seconds);
**wholesale is the least** (contracted B2B partners who set their own consumer prices). Naive OLS makes every channel look far
...
| wholesale | £56.0m | £3.3m | £1.9m | £50.8m | 91% |
...
inelastic **wholesale / Post Office**, hold roughly steady where high cost-to-serve
...
channels deliver more than that (accretive), inelastic wholesale does not (dilutive). A
...
(`../04_satisfy_the_regulator/02_fair_value_assessment.md`, `role_fig3_fair_value.png`):
...
**See also:** [`../00_the_role/the_job_and_the_evidence.md`](../00_the_role/the_job_and_the_evidence.md) maps each JD bullet to the exact
file/figure that evidences it, plus five interview stories;
[`RESULTS.md`](RESULTS.md) has the auto-generated numbers and figures.
