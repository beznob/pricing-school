...
| tmc | -0.70 | -0.04 | -0.68 | 2,580 |

Digital is the most price-sensitive channel (price-transparent); TMC the least. OLS understates sensitivity everywhere — pricing on it would systematically over-charge.
...
- See `FAIR_VALUE_ASSESSMENT.md` for the full documented assessment and remediation actions.
