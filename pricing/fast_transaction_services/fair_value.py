...
def generate_fair_value_assessment(portfolio: pd.DataFrame, out_path: str) -> str:
    ...
    L = []
    L.append("# Fair Value Assessment — Prepaid Travel Card (FCA Consumer Duty, PRIN 2A.4)")
    L.append("")
...
if __name__ == "__main__":
    ...
    out = generate_fair_value_assessment(port, os.path.join(here, "FAIR_VALUE_ASSESSMENT.md"))
    print(f"\nWrote {out}")
