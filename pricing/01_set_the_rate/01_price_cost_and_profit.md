# 1.1 · Price, Cost, Profit — the four numbers everything else is built on
...
businesses like currency exchange, insurance, and groceries. [File 1.4](04_price_volume_mix_and_leakage.md) turns
...
2. **[File 1.4](04_price_volume_mix_and_leakage.md)** runs the same arithmetic at company scale. Because profit is
   ...
   kiosk, multiplied.
3. **[File 1.3](03_elasticity.md)** turns margin from a *result* you calculate into a *decision*
...
4. **[File 3.2](../03_defend_the_plan/02_kpis_and_stakeholders.md)** is the same numbers spoken upward: the CFO's "are we on
   plan?" is answered with a **revenue bridge** — break-even thinking with a
   committee in the room.
5. **In code:**
   [`../engine/distribution_economics.py`](../engine/distribution_economics.py)
