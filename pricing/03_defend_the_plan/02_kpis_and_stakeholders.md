# 3.2 · The Commercial Side — KPIs, stakeholders, and getting decisions through

*(The commercial side of this track. Technique gets you into the room;
...
**The bridge in:** every tool in this file has a foundation-file ancestor. The
revenue bridge is [File 1.4](../01_set_the_rate/04_price_volume_mix_and_leakage.md)'s price–volume–mix formalised; conversion and rank
KPIs carry [File 1.3](../01_set_the_rate/03_elasticity.md)'s elasticity through [The workflow appendix](../appendix/data_science_workflow.md)'s model; contribution and
pocket margin are [File 1.1](../01_set_the_rate/01_price_cost_and_profit.md) and [file 1.4](../01_set_the_rate/04_price_volume_mix_and_leakage.md); fair-value MI is [File 4.1](../04_satisfy_the_regulator/01_segments_and_fairness.md) made a standing
report; and the "reversible experiment with guardrails" framing that gets
decisions through committee is [File 2.1](../02_prove_the_change/01_averages_and_uncertainty.md)'s expected-value-plus-bounded-downside,
...
- **Contribution & pocket margin** — [File 1.1](../01_set_the_rate/01_price_cost_and_profit.md) and [file 1.4](../01_set_the_rate/04_price_volume_mix_and_leakage.md). The pair that stops
...
- **CLV (customer lifetime value)** — total profit over the whole
  ...
  customer for years ([File 4.1](../04_satisfy_the_regulator/01_segments_and_fairness.md)'s retention logic; the card's defensive role).
...
- **AOP (annual operating plan)** — the year's promised numbers, by line
  ...
  effect + price effect + mix effect + competitor effect ([File 1.4](../01_set_the_rate/04_price_volume_mix_and_leakage.md), formalised).
- **Fair-value MI** — the standing fairness report ([File 4.1](../04_satisfy_the_regulator/01_segments_and_fairness.md)): outcome
...
| Ops / cash logistics | simplicity, stable plans | pricing spikes wrecking stock plans | stockouts, forecast accuracy ([File 2.4](../02_prove_the_change/04_forecasting_and_stockouts.md)) |
| Compliance / risk | documented fairness | surprises and complaints | fair-value MI, guardrails ([File 4.1](../04_satisfy_the_regulator/01_segments_and_fairness.md) and [the workflow appendix](../appendix/data_science_workflow.md)) |
| Data science | clean tests, model health | being asked to bless dirty reads | MDE, holdouts, OOT performance ([File 2.2](../02_prove_the_change/02_tests_and_experiments.md) and [the workflow appendix](../appendix/data_science_workflow.md)) |
...
3. **Frame it as a reversible experiment with guardrails**, not a bet:
   ...
   opposition — you're not asking anyone to be wrong forever ([File 2.1](../02_prove_the_change/01_averages_and_uncertainty.md) §5).
...
5. **Lose small battles on purpose.** Concede the visible discount the sales
   ...
   tiers) that actually moves the P&L ([File 1.4](../01_set_the_rate/04_price_volume_mix_and_leakage.md)).
...
The margin test from [File 2.1](../02_prove_the_change/01_averages_and_uncertainty.md) (+2%, range crossing zero, P(positive)=90%):
...
- **Days 1–30 — listen and diagnose, change nothing.** Stakeholder tour
  ...
  test ([File 2.2](../02_prove_the_change/02_tests_and_experiments.md))? **Leakage audit** ([File 1.4](../01_set_the_rate/04_price_volume_mix_and_leakage.md)). Fair-value review ([File 4.1](../04_satisfy_the_regulator/01_segments_and_fairness.md)).
...
[`../engine/aop_scenario.py`](../engine/aop_scenario.py).
