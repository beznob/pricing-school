# 09 · Forecasting and Stockouts — when your own data lies to you
...
- **Noise** — the leftover wobble nobody can predict. (File 05's spread.)
...
## 3. The death spiral — the most beautiful trap in this school
...
3. **Mind the fairness line** (File 07): the Friday walk-up customer is
...
their campaign did it. How do you settle it? (One word from File 06.)
...
old plan, compare (File 06). If the campaign did it, the holdout branches
...
1. **This file:** sales ≠ demand, censoring, the death spiral, and
   ops-before-pricing.
2. **File 05's suspicion, sharpened:** a sales figure is a summary that
   ...
   *couldn't* record.
3. **File 11 gives demand a shape:** arrivals are Poisson or negative
...
4. **File 06 settles the credit:** when your stock fix and marketing's
   ...
   clothes.
5. **File 07 guards the pricing rung:** if a hard limit remains and you
   price the scarcity, remember the Friday walk-up is a **captive
   customer** — modest, documented, signposted, or not at all.
6. **In code:**
   [`../fres_prep/N3_censored_demand_stockouts.ipynb`](../fres_prep/N3_censored_demand_stockouts.ipynb)
