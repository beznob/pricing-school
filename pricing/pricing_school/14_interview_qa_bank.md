...
*(Distilled from the case study's interview Q&A, the fres_prep 60-second
...
glossary's formula cheat-sheet, File 10.)
...
**Full versions:** every fres_prep notebook ends with a 60-second spoken
answer and three pushed-deeper follow-ups —
[`../fres_prep/README.md`](../fres_prep/README.md) maps them to questions.
The case-study Q&A is in
[`../fast_transaction_services/dynamic_pricing_and_elasticity_case_study.md`](../fast_transaction_services/dynamic_pricing_and_elasticity_case_study.md) §8.
