# 04 · Why Did Profit Move? — price, volume, mix, and the leaks
...
you look for it. File 07 shows mix creating a *fairness* problem too.
...
much of the 3% is *yours*? The honest answer needs a comparison group (File
06). For now, one sentence to remember:
...
1. **This file:** the price > cost > volume > fixed ranking, the
   ...
   pocket price.
2. **File 06** turns §4's warning ("don't claim the market's win") into a
...
3. **File 07** shows the mix effect doing something more dangerous than
...
4. **File 13** formalises the decomposition for the boardroom: the **revenue
...
5. **In code:**
   [`../fres_prep/N5_pocket_price_waterfall.ipynb`](../fres_prep/N5_pocket_price_waterfall.ipynb)
