# 18 · Pricing Strategy & Offer Design — the senior reference

*(Consolidated from the former `pricing_manager_handbook` chapters 01, 02, 07, 12,
13 and 14. Where the school files teach the foundations in plain English, this
...
how much surplus you must leave the customer (File 07).
...
| **Revealed preference** | Transactions + experiments (Files 03, 06) | The truth — use surveys for hypotheses, experiments to decide |
...
Relevant via TMCs and corporate/agency channels. Different physics: negotiated
...
best health metric), quick ratio, LTV = ARPU × margin ÷ churn (see File 20 for
the discounted form).
