...
```bash
jupyter lab ../02_prove_the_change/lab_01_data_foundation.ipynb    # run top to bottom — writes the CSVs
...
Do not take these counts on trust — `../02_prove_the_change/lab_01_data_foundation.ipynb` regenerates the
...
[lab 2.4](../02_prove_the_change/lab_04_experiments_and_ab_testing.ipynb) and [lab 2.5](../02_prove_the_change/lab_05_causal_inference.ipynb) are for. Skipping that step is the single most expensive
...
Positive gap = dearer than the market. [Lab 1.3](../01_set_the_rate/lab_03_price_optimisation.ipynb) costs that gap in retention.
...
- **[`../03_defend_the_plan/01_finance_for_pricing.md`](../03_defend_the_plan/01_finance_for_pricing.md)** — the financial
  concepts behind every one of these queries
- **[`../engine/pricing_finance.py`](../engine/pricing_finance.py)** — those concepts as runnable,
  doctested code
- `data/DATA_DICTIONARY.md` — every table and column, written by [lab 2.1](../02_prove_the_change/lab_01_data_foundation.ipynb)
